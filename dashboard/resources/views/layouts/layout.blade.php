...
<head>
    ...
    <title>Infinity System Administrative</title>
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>Bintang Tobing</span></li>
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-envelope-o"></span> Reports <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
                          <li><a href="#">Sales Order Report</a></li>
                          <li><a href="#">Sales Invoices Report</a></li>
                          <li><a href="#">Check-in Report</a></li>
